...
RawRunTag="101840"
RunTag="Exp101840"
ComparisonTag="TransformerPlus_ConfigB_vs_ConfigC_Exp101840"
...
echo ""
echo "============================================================"
echo "CREATE VALID RUNTAG ALIAS"
echo "============================================================"

mkdir -p Outputs/Experiments

if [[ ! -e "Outputs/Experiments/${RunTag}" ]]; then
  ln -s "${RawRunTag}" "Outputs/Experiments/${RunTag}"
  echo "Created symlink: Outputs/Experiments/${RunTag} -> ${RawRunTag}"
else
  echo "Alias already exists: Outputs/Experiments/${RunTag}"
fi
